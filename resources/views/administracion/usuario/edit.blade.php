	...
	<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				...
				<input type="text" name="tipo" required value="{{$usuario->tipo}}" class="form-control" placeholder="Ingrese tipo...">
			</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				<label for="imagen">Imagen</label>
				<input type="file" name="imagen" value="{{$usuario->imagen}}" class="form-control">
			</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
